...
class MeshNetwork:
    ...
    def remove_node(self, node_id: int) -> bool:
        ...
        # Fix #8: clean up neighbors and routing table before deleting the node
    ...
    def route_message(self, message: MeshMessage) -> bool:
        ...
        # Fix #6: skip path[0] (source) — it already sent, not a recipient
    ...
    def get_network_stats(self) -> dict:
        ...
        dropped = len(self.dropped_messages)
        total_messages = delivered + dropped
        ...
        return {
            ...
            "delivery_rate": delivered / total_messages if total_messages > 0 else 0.0,  # Fix #7: guard zero-division
